...
(46, 'hererer', '2020-09-04', 60000, 10800, 0, 70800, 444, 70356, 'Card'),
(47, 'gerer  herea', '2020-09-04', 60000, 10800, 0, 70800, 8000, 62800, 'Cash');
...
(40, 47, 'Samsung Galaxy S8', 60000, 1);
...
(15, 5, 1, 'Samsung Galaxy S8', 60000, 983, '2018-01-31', '1'),
...
INSERT INTO `user` (`id`, `username`, `email`, `password`, `usertype`, `image`, `register_date`, `last_login`, `notes`) VALUES
(9, 'alvingahalino', 'alvingumatay@gmail.com', '$2y$08$FyGUREaRtV9MEsVjEAYneO1PI.53fwNVE6vM8H0Plcqxygc/9vJrS', '', '', '2020-04-03', '2022-02-25 01:02:33', '');
